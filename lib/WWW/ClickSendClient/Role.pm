...
#
package WWW::ClickSendClient::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'WWW::ClickSendClient::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'WWW::ClickSendClient::Configuration',
              default => sub { WWW::ClickSendClient::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'ClickSend v3 API',
                          app_version => '3.1',
...
sub _build_af {
	...
	return WWW::ClickSendClient::ApiFactory->new(%args);
}

=head1 NAME

WWW::ClickSendClient::Role - a Moose role for the ClickSend v3 API

=head2 ClickSend v3 API version: 3.1

=head1 VERSION

Automatically generated by the Perl ClickSend Codegen project:
