...
#
package WWW::ClickSendClient::SearchApi;
...
# @param int $limit Number of records per page (optional, default to 10)
{
    ...
    __PACKAGE__->method_documentation->{ 'search_contacts_lists_get' } = { 
...
# @return string
#
sub search_contacts_lists_get {
    my ($self, %args) = @_;

    # verify the required parameter 'q' is set
    unless (exists $args{'q'}) {
      croak("Missing the required parameter 'q' when calling search_contacts_lists_get");
    }

    # parse inputs
    my $_resource_path = '/search/contacts-lists';
