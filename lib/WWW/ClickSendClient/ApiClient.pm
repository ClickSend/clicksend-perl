...
#
package WWW::ClickSendClient::ApiClient;
...
use WWW::ClickSendClient::Configuration;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'WWW::ClickSendClient::Configuration' ) {
        $config = $_[0];
    } else {
        $config = WWW::ClickSendClient::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("WWW::ClickSendClient::Object::$class")->new;
        if (ref $data eq "HASH") {
