...
#
package WWW::ClickSendClient::Object::Subaccount;
...
__PACKAGE__->class_documentation({description => 'Accounts that are maintained under a main account',
                                  class => 'Subaccount',
                                  required => [], # TODO
}                                 );
