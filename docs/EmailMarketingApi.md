...
> File email_campaign_history_export_get(email_campaign_id => $email_campaign_id, date_from => $date_from, date_to => $date_to)
...
# **email_campaign_put**
> string email_campaign_put(email_campaign_id => $email_campaign_id)
...
eval { 
    my $result = $api_instance->email_campaign_put(email_campaign_id => $email_campaign_id);
    print Dumper($result);
};
if ($@) {
