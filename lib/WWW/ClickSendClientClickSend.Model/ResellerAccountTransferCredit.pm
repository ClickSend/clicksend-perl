...
#
package WWW::ClickSendClient::Object::ResellerAccountTransferCredit;
...
__PACKAGE__->class_documentation({description => 'ResellerAccountTransferCredit model',
