...
#
package WWW::ClickSendClient::FAXDeliveryReceiptRulesApi;
...
# @param int $receipt_rule_id Receipt rule id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'fax_delivery_receipt_automation_delete' } = { 
...
# @return string
#
sub fax_delivery_receipt_automation_delete {
    my ($self, %args) = @_;

    # verify the required parameter 'receipt_rule_id' is set
    unless (exists $args{'receipt_rule_id'}) {
      croak("Missing the required parameter 'receipt_rule_id' when calling fax_delivery_receipt_automation_delete");
    }

    # parse inputs
    my $_resource_path = '/automations/fax/receipts/{receipt_rule_id}';
...
# @param int $receipt_rule_id Receipt rule id (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'fax_delivery_receipt_automation_get' } = { 
...
# @return string
#
sub fax_delivery_receipt_automation_get {
    my ($self, %args) = @_;

    # verify the required parameter 'receipt_rule_id' is set
    unless (exists $args{'receipt_rule_id'}) {
      croak("Missing the required parameter 'receipt_rule_id' when calling fax_delivery_receipt_automation_get");
    }
...
# @param DeliveryReceiptRule $delivery_receipt_rule fax delivery receipt rule model (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'fax_delivery_receipt_automation_post' } = { 
...
# @return string
#
sub fax_delivery_receipt_automation_post {
    my ($self, %args) = @_;

    # verify the required parameter 'delivery_receipt_rule' is set
    unless (exists $args{'delivery_receipt_rule'}) {
      croak("Missing the required parameter 'delivery_receipt_rule' when calling fax_delivery_receipt_automation_post");
    }

    # parse inputs
    my $_resource_path = '/automations/fax/receipts';
...
# @param DeliveryReceiptRule $delivery_receipt_rule Delivery receipt rule model (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'fax_delivery_receipt_automation_put' } = { 
...
# @return string
#
sub fax_delivery_receipt_automation_put {
    my ($self, %args) = @_;

    # verify the required parameter 'receipt_rule_id' is set
    unless (exists $args{'receipt_rule_id'}) {
      croak("Missing the required parameter 'receipt_rule_id' when calling fax_delivery_receipt_automation_put");
    }

    # verify the required parameter 'delivery_receipt_rule' is set
    unless (exists $args{'delivery_receipt_rule'}) {
      croak("Missing the required parameter 'delivery_receipt_rule' when calling fax_delivery_receipt_automation_put");
    }
...
# @param int $limit Number of records per page (optional, default to 10)
{
    ...
    __PACKAGE__->method_documentation->{ 'fax_delivery_receipt_automations_get' } = { 
...
# @return string
#
sub fax_delivery_receipt_automations_get {
    my ($self, %args) = @_;

    # verify the required parameter 'q' is set
    unless (exists $args{'q'}) {
      croak("Missing the required parameter 'q' when calling fax_delivery_receipt_automations_get");
    }
