# WWW::SwaggerClient::VoiceDeliveryReceiptRulesApi

## Load the API package
```perl
use WWW::SwaggerClient::Object::VoiceDeliveryReceiptRulesApi;
```
...
my $api_instance = WWW::SwaggerClient::VoiceDeliveryReceiptRulesApi->new(
...
my $delivery_receipt_rule = WWW::SwaggerClient::Object::DeliveryReceiptRule->new(); # DeliveryReceiptRule | voice delivery receipt rule model
...
> string voice_delivery_receipt_automations_get(page => $page, limit => $limit)
...
eval { 
    my $result = $api_instance->voice_delivery_receipt_automations_get(page => $page, limit => $limit);
    print Dumper($result);
};
if ($@) {
