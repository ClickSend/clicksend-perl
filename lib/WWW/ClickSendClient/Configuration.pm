...
#
package WWW::ClickSendClient::Configuration;
...
=head1 Name
        ...
        WWW::ClickSendClient::Configuration - holds the configuration for all WWW::ClickSendClient Modules
...
default: ClickSend-Codegen/1.0.0/perl
...
sub new {
	...
	$p{http_timeout} //= 180;
	$p{http_user_agent} //= 'ClickSend-Codegen/1.0.0/perl';
	...
	# base_url
        $p{base_url} //= 'https://rest.clicksend.com/v3';
